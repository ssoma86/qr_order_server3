...
public class DiscountController {
	...
	// JsonView
	public interface DiscountControllerJsonView extends StoreControllerJsonView {}
	public interface DiscountControllerCommonJsonView {}
	...
	public void up(@Validated({ DiscountValid.class, DiscountInfoValid.class }) @RequestBody Discount discount, @PathVariable Integer discountCd) throws Exception {
	...
	@GetMapping
	@JsonView(DiscountControllerJsonView.class)
	public List<Discount> search(Integer storeCd, String discountNm, String useYn) {
		List<Discount> discountList = service.findDiscountList(storeCd, discountNm, useYn);
	...
	@GetMapping("/forMenu")
	@JsonView(DiscountControllerJsonView.class)
	public List<Discount> getForMenu(Integer storeCd) {
		Code target = codeService.findOneByTopCodeValAndVal("DISCOUNT_TARGET", "menu");
		
		return service.findByTarget(storeCd, target.getCd());
	}
